...
MyTraitDialog::MyTraitDialog(wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style) : wxDialog( parent, id, title, pos, size, style ){
	SetClientSize(wxSize(200,110));

    m_trait = new wxSlider( this, wxID_ANY, 0,0, 20, wxPoint(25,10), wxSize(150,50), wxSL_HORIZONTAL|wxSL_LABELS );
